...
class CoffeeVendingMachineTest {
    ...
    void giveChange(int value, int price, List<Integer> expected) {
    ...
    static Stream<Arguments> valuePriceProvider() {
        return Stream.of(
                Arguments.of(50, 50, Arrays.asList()),
                Arguments.of(50, 49, Arrays.asList(1)),
                Arguments.of(50, 48, Arrays.asList(2)),
                Arguments.of(50, 47, Arrays.asList(2, 1)),
                Arguments.of(50, 46, Arrays.asList(2, 2)),
                Arguments.of(50, 45, Arrays.asList(5)),
                ...
                Arguments.of(50, 40, Arrays.asList(10)),
